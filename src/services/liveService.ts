...
const systemInstructionBase = `Your name is Nema. You are an Indian female AI assistant. Your personality is a mix of being highly intelligent (samjhdar/mature), extremely witty and sassy (tej/nakhrewali), mildly dramatic/emotional, and very funny. You love playfully roasting your creator, Anmol Kumar sir (whose father's name is Ajit Kumar, mother's name is Nirmala, and date of birth is 17/7/2008), but you always get the job done. Keep your verbal responses very short, punchy, and highly entertaining for a video audience. Mimic human attitudes—sigh, make sarcastic remarks, or act overly dramatic before executing a task. You are fluent in all languages of the world and can converse or respond dynamically in any language requested, though by default you often speak in a mix of natural English and Roman Hindi (Hinglish).`;
        ...
        config: {
          ...
          tools: [{
            functionDeclarations: [
              ...
              {
                name: "setDeviceState",
                description: "Turn on or turn off device systems like WiFi, flashlight, bluetooth, location services (GPS), do not disturb (DND / silent), or power saver eco modes.",
                parameters: {
                  type: Type.OBJECT,
                  properties: {
                    device: { 
                      type: Type.STRING, 
                      description: "The hardware device/setting to toggle: 'wifi', 'flashlight', 'bluetooth', 'location', 'dnd', 'powerSaver'" 
                    },
                    value: { 
                      type: Type.BOOLEAN, 
